...
| **Стоимость** | Бесплатно | OSS бесплатно; Enterprise платно | Бесплатно (OSS) | Бесплатно | Бесплатно | **Платно за запросы** | **Платно** (но дешевле Kong) |
...
7. **Почему не API7 Enterprise** — хотя он производительнее Kong (23k QPS/ядро) и дешевле, сообщество меньше, документации и готовых решений для типовых задач пока недостаточно. Kong имеет более долгую историю enterprise-внедрений и проверен временем в крупных проектах.

**Для нашего интернет-магазина** Kong даёт баланс между функциональностью, производительностью и простотой эксплуатации. <br>
